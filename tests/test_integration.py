...
def prepare_temp_dir(doc_id: str, incremental_update_dir: str, limit):
    ...
    # Shorten
    family_document.pdf_data.page_metadata = family_document.pdf_data.page_metadata[:limit]
...
def test_integration(test_vespa):
    ...
    with TemporaryDirectory() as incremental_update_dir:
        ...
        # After update
        search_weights_2 = get_vespa_data(test_vespa, SEARCH_WEIGHTS_SCHEMA, "default_weights")
        no_change_family_2 = get_vespa_data(test_vespa, FAMILY_DOCUMENT_SCHEMA, NO_CHANGE_FAMILY)
    ...
    with TemporaryDirectory() as incremental_update_dir:
        ...
        # After update
        search_weights_3 = get_vespa_data(test_vespa, SEARCH_WEIGHTS_SCHEMA, "default_weights")
        no_change_family_3 = get_vespa_data(test_vespa, FAMILY_DOCUMENT_SCHEMA, NO_CHANGE_FAMILY)
    ...
    search_weights_4 = get_vespa_data(test_vespa, SEARCH_WEIGHTS_SCHEMA, "default_weights")
    no_change_family_4 = get_vespa_data(test_vespa, FAMILY_DOCUMENT_SCHEMA, NO_CHANGE_FAMILY)
    ...
    assert no_change_family_1 == no_change_family_2 == no_change_family_3 == no_change_family_4
    assert no_change_family_passages_1 == no_change_family_passages_2 == no_change_family_passages_3 == no_change_family_passages_4
